		...
		<section class="content"> <!--订单信息-->
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control"
							   value="${product.productStatusStr}" >
					</div>

				</div>
			</div>
			<div id="cbx">
				<button type="button" class="btn bg-maroon" onclick="location.href='${pageContext.request.contextPath}/product/saveProduct?id=${product.id}'">保存</button>
